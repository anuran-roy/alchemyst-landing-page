  ...
  return (
    <>
      <div className="font-league bg-bg-primary overflow-x-hidden">
        <div className="landing__section__1 w-full min-h-max py-5 lg:px-5 flex justify-center items-center flex-col bg-bg-primary relative backdrop-blur-sm bg-opacity-30">
          ...
          <div className="section-1 flex-1 w-[85%] flex justify-center items-center py-10 my-16 flex-col lg:flex-row">
            <div className="landing__text__one flex-1 lg:pl-10 ">
              ...
              <div className="overflow-y-hidden">
                ...
                >
                  Maya is India’s first digital employee, <br />
                  designed to automate your sales.
                </div>
              </div>
            ...
            <div className="landing__image__container flex-1 relative flex justify-center items-center mt-16">
          ...
          <div className="section-2 flex-1 p-1 w-full flex justify-start pt-0 lg:pt-10 items-center flex-col mt-8 lg:mt-28">
            <div className="landing__text__section__2 text-white text-5xl font-semibold my-3 flex justify-center items-center text-center tracking-wide mb-10 overflow-hidden ">
              <div
                // variants={{
            ...
            <div className="overflow-y-hidden" ref={section1SubTextRef}>
              <div className="landing__text__section__subconten  text-white text-xl font-normal my-3t text-center">
                <p>
                  Alchemysts can become integral members of your <br /> business
                  and start-up teams.
                </p>
              </div>
            </div>
        ...
        <div className="artisans__section w-full min-h-max py-8 lg:py-16 px-5 flex justify-center items-center flex-col bg-bg-primary relative backdrop-blur-sm bg-opacity-30 mt-16">
          <div
            className={`absolute top-[10rem] -left-[10rem] w-[20rem] h-[20rem] bg-gradient-to-r from-orange-500 to-orange-400 rounded-full blur-[20rem] -z-10`}
          ></div>
          ...
          <div className="artisans__inner__section w-[90%] flex justify-center items-center gap-8 md:gap-4 flex-col md:flex-row  sm:px-[5rem]">
            {artisans.map((artisan, index) => {
              return (
                <div
                  key={artisan.id}
                  className="min-w-[23rem] sm:min-w-[25rem] md:min-w-[20rem] lg:min-w-[25rem] h-[40rem] p-[3px] rounded-xl bg-gradient-to-b from-[#82D6D2] to-[#82D6D200]"
                >
        ...
        <div className="chat__with__ease__section w-full min-h-max lg:py-5 flex justify-center items-center px-2 lg:px-5 bg-bg-primary backdrop-blur-sm bg-opacity-30">
          ...
          <div className="section__2__inner__container w-[100%] lg:w-[85%] flex justify-center items-center gap-10 my-16 py-4 flex-col-reverse md:flex-row">
            <div className="section__2__image__container flex-1 flex justify-end items-center p-4">
              <Image
                src={section2img}
                alt="landing__image__two"
                width={500}
        ...
        <div className="empowers__section w-full min-h-max py-5 flex justify-center items-center lg:px-5 bg-bg-primary relative backdrop-blur-sm bg-opacity-30">
          ...
          <div className="section__3__inner__container w-[80%] flex justify-center items-center gap-2 my-20 flex-col lg:flex-row">
            ...
            <div className="section__3__image__container flex-1 flex justify-center items-center relative h-[25rem] mt-20">
              <Image
                src={imgborder}
                alt="landing__image__two"
                width={500}
        ...
        <div className="additional__info__section w-full min-h-max py-5 flex justify-center items-center lg:px-5 bg-bg-primary">
          <div className="section__4__inner__container w-[80%] flex flex-col-reverse lg:flex-row justify-center items-center gap-2 my-20">
            <div className="section__4__image__container flex-1 flex justify-center items-center relative h-[25rem]  mt-24 md:mt-0">
              <Image
                src={imgborder}
                alt="landing__image__two"
                width={500}
        ...
        <div
          id="teamsSection"
          className="meet__our__team__section w-full min-h-max py-5 flex justify-center items-center px-5 bg-bg-primary flex-col relative backdrop-blur-sm bg-opacity-0"
        >
          ...
          <div className="overflow-hidden">
            <div className="text-white font-semibold text-4xl w-full flex justify-center items-center mb-10 gap-2">
              Meet our{" "}
              <span className="inline-block bg-gradient-to-br from-teal-500 to-white bg-clip-text text-transparent">
                {" "}
                Team
              </span>
            </div>
                      ...
                      <ul>
                        {team.achievements.map((item, ind) => {
                          return (
                            <li
                              key={item.id}
                              className="text-white font-normal text-lg pb-3"
                            >
                              <p>{item.value}</p>
                            </li>
                          );
